...
--
-- Table structure for table `projeto_tecnologia`
--

DROP TABLE IF EXISTS `projeto_tecnologia`;
...
--
-- Dumping data for table `projeto_tecnologia`
--

LOCK TABLES `projeto_tecnologia` WRITE;
/*!40000 ALTER TABLE `projeto_tecnologia` DISABLE KEYS */;
/*!40000 ALTER TABLE `projeto_tecnologia` ENABLE KEYS */;
UNLOCK TABLES;
